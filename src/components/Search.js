...
const Search = () => {
  ...
  return (
    ...
    <PropertyDropDown/>
    <PriceRangeDropDown/>
    <button onClick={()=> handleClick()} className='bg-sky-200 hover:bg-sky-300 transition w-full lg:max-w-[120px] h-10 rounded-lg flex justify-center items-center text-white text-lg '>
   <RiSearch2Line/>
    </button>
    </div>
  )
